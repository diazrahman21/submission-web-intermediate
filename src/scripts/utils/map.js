import { map, tileLayer, Icon, icon, marker, popup, latLng } from 'leaflet'; // ← Tambahkan latLng
...
export default class Map {
  ...
  changeCamera(coordinate, zoomLevel = null) {
    if (!zoomLevel) {
      this.#map.setView(latLng(coordinate), this.#zoom); // ← sekarang latLng sudah dikenali
      return;
    }
